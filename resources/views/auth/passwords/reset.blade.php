...
<body>
                                    ...
                                    <div class="mb-0">
                                        <div class="col-md-8 offset-md-2">
                                            ...
                                            <div class="auth-links">
                                                <a class="btn btn-link auth-link" href="{{ route('login') }}">{{ __('Вернуться к входу') }}</a>
                                            </div>
    ...
    .dark-theme .auth-legal-links a { color: #94a3b8; }
    .dark-theme .auth-legal-links a:hover { color: #63B3ED; }
